    ...
    <PersonShell person={person} active="/record" title="Full record">
      ...
      <section className="mt-10">
        ...
        <p className="mt-1 text-xs text-olive">
          ...
          <code className="text-xs">{summary.provenance.generator}</code>
        </p>
          ...
          {[...timeline.entries].reverse().map((e) => (
            ...
            >
              ...
              <details className="mt-1 text-xs text-olive">
                ...
                <p className="mt-1">
                  Event <code className="text-xs">{e.eventId}</code> · recorded {e.recordedAt}
                </p>
                <pre className="mt-1 overflow-x-auto rounded bg-ivory p-2 text-xs">
