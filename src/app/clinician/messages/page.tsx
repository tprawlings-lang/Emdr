...
export default async function MessagesPage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      <h1 className="type-display text-3xl font-medium text-ground">Messages</h1>
      <p className="measure mt-2 text-olive">Secure clinician–member messaging is not part of this environment.</p>
