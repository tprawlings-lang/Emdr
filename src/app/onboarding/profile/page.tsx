    ...
    <main className="mx-auto max-w-2xl px-6 py-12">
      ...
      {step === "welcome" && (
        <section className="mt-10">
          <h1 className="type-display text-4xl font-medium">Welcome to Steady</h1>
      ...
      {step === "support" && (
        <form action={saveSupportStatus} className="mt-10">
          <h1 className="type-display text-3xl font-medium">Your current support</h1>
      ...
      {step === "background" && (
        <form action={saveTraumaContext} className="mt-10">
          <h1 className="type-display text-3xl font-medium">A little background</h1>
      ...
      {step === "triggers" && (
        <form action={saveTriggers} className="mt-10">
          <h1 className="type-display text-3xl font-medium">Known triggers</h1>
      ...
      {step === "trigger-details" && (
        <form action={saveTriggerDetails} className="mt-10">
          <h1 className="type-display text-3xl font-medium">How these show up</h1>
          <p className="mt-2 text-olive">
      ...
      {step === "warning-signs" && (
        <form action={saveWarningSigns} className="mt-10">
          <h1 className="type-display text-3xl font-medium">Early warning signs</h1>
          <p className="mt-2 leading-relaxed text-olive">
      ...
      {step === "readiness" && (
        <form action={saveReadinessAssessment} className="mt-10">
          <h1 className="type-display text-3xl font-medium">Where you are today</h1>
          <p className="mt-2 text-olive">
      ...
      {step === "safety-plan" && (
        <form action={saveSafetyPlan} className="mt-10">
          <h1 className="type-display text-3xl font-medium">Your safety plan</h1>
          <p className="mt-2 leading-relaxed text-olive">
      ...
      {step === "companion" && (
        <form action={saveCompanionPrefs} className="mt-10">
          <h1 className="type-display text-3xl font-medium">Your companion</h1>
          <p className="mt-2 leading-relaxed text-olive">
      ...
      {step === "focus-chat" && (
        <section className="mt-10">
          <h1 className="type-display text-3xl font-medium">In your own words</h1>
          <p className="mt-2 leading-relaxed text-olive">
      ...
      {step === "summary" && (
        <section className="mt-10">
          <h1 className="type-display text-4xl font-medium">Your starting place</h1>
