...
export default async function ProfileOnboardingPage({
  ...
  if (await profileComplete(user.id)) redirect("/app/today");
    ...
    <main className="mx-auto max-w-2xl px-6 py-12">
      ...
      {step === "welcome" && (
        <section className="mt-10">
          ...
          <div className="mt-8 flex flex-col gap-3">
            <Link
              href="/app/onboarding/profile?step=support"
        ...
        <form action={saveTriggerDetails} className="mt-10">
          ...
          {triggers.length === 0 && (
            <p className="mt-6 text-olive">
              ...
              <Link href="/app/onboarding/profile?step=triggers" className="underline">
                go back
              </Link>{" "}
              or continue.
            </p>
        ...
        <section className="mt-10">
          ...
          <div className="mt-6 rounded-3xl border border-ground/10 bg-ivory p-5 shadow-soft">
            <CompanionChat
              ...
              doneHref="/app/onboarding/profile?step=summary"
      ...
      {step === "summary" && (
        <section className="mt-10">
          ...
          <Link
            href="/app/onboarding/profile?step=triggers"
