...
export const metadata = { title: "Engagement — Steady Intelligence" };
...
export default async function PayerOverviewPage() {
  ...
  return (
    <PayerPage
      layer="progress"
      here="/payer/engagement"
      title="Engagement"
      lede="Eligibility through to active use, stage by stage, against the plan's own denominator."
    >
      {!envelope ? (
        ...
        <EnvelopeView envelope={envelope} title="Engagement" audience="operations">
          {(p) => (
            <WithNote
              note={
                <Note
