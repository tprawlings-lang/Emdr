...
export const MOVEMENT: Practice[] = [
  {
    ...
    segments: [
      ...
      { text: "Bring your head back to center. Let your chin drop gently toward your chest, and rest there for a few slow breaths.", seconds: 16 },
  ...
  },
  {
    ...
    note: "Do it seated or standing. Keep any shift of weight small and stay in control — the point is to feel steady, not to challenge your balance.",
    segments: [
      ...
      { text: "If standing, let your weight settle a little further into your heels, then evenly across both feet, feeling how you stay balanced.", seconds: 16 },
