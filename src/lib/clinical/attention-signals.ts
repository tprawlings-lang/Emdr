...
// The vocabulary lives in its own module so a client component — the Quick
// Review Drawer — can import the labels without pulling this file's database
// dependencies into the browser bundle. Re-exported so every server-side caller
// keeps one import.
export {
  ATTENTION_BANDS, BAND_LABEL, SIGNAL_STATES, OPEN_STATES, isOpenState,
  DISMISS_REASONS, DISMISS_REASON_LABEL, CARE_ACTIONS, AttentionSignalError,
