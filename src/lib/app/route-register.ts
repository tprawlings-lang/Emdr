...
export const ROUTE_REGISTER: RouteEntry[] = [
  ...
  { path: "/app/terms", audience: "member", job: "Read what changed about the pilot since they joined, and say yes or no to it.", workspace: "member_day", state: "working", evidence: "Reached from a notice on Today, never by redirect: it is an ask, not a gate. Declining is recorded and costs nothing — handling stays exactly as it was — and somebody who has decided either way is never shown the notice again." },
  ...
  { path: "/app/programs", audience: "member", job: "Join, leave or pick up a program.", workspace: "member_activity", state: "working", evidence: "Handoff 10 §3.2: Moving Toward, signed (CV10_B01, B02, F02)." },
  { path: "/app/programs/[programId]", audience: "member", job: "See a program's parts and where each stands.", workspace: "member_activity", state: "working" },
  { path: "/app/programs/[programId]/entry", audience: "member", job: "Answer a program's entry questions on joining.", workspace: "member_activity", state: "working", evidence: "Handoff 10 1C: Steadier Sleep's sleep-entry-v1 (CV10_C04). Any yes leaves out the part that asks a member to get up at night, and only that part; asked again after leaving and rejoining." },
  { path: "/app/programs/[programId]/[unitId]", audience: "member", job: "Work through one part of a program.", workspace: "member_activity", state: "working", evidence: "Each part re-asks today's gate; below its floor it says 'not today' and offers grounding." },
  { path: "/app/programs/[programId]/[unitId]/activity", audience: "member", job: "Do a part's activity; what is written is screened for crisis language before it is saved.", workspace: "member_activity", state: "working" },
  { path: "/app/assigned/[assignmentId]", audience: "member", job: "Start a practice a clinician assigned, after a distress rating.", workspace: "member_activity", state: "working", evidence: "Handoff 10 Phase 3 (CV10_E01, unsigned): demo only; reached from Today when a live assignment exists; otherwise says it is not available." },
  { path: "/app/assigned/[assignmentId]/run/[runId]", audience: "member", job: "Work through one step of an assigned practice, with stop on every step.", workspace: "member_activity", state: "working" },
  { path: "/app/assigned/[assignmentId]/run/[runId]/end", audience: "member", job: "Finish or stop an assigned practice with a distress rating after.", workspace: "member_activity", state: "working", evidence: "A rise of 3 or more, or above 7, shows grounding and SOS and alerts the assigning clinician." },
  { path: "/app/activities/thoughts", audience: "member", job: "See, start or delete your own thought records.", workspace: "member_activity", state: "working", evidence: "Handoff 10 2B (CV10_D04): private to the member — no clinician surface reads them and the companion cannot." },
  { path: "/app/activities/thoughts/new", audience: "member", job: "Work through one thought; what is written is screened for crisis language before it is saved.", workspace: "member_activity", state: "working", evidence: "Cautious tier, ceiling 6, asked again here; a strength of 8 or more offers grounding first." },
  { path: "/app/activities/skills", audience: "member", job: "Do a short step-by-step skill.", workspace: "member_activity", state: "working", evidence: "Handoff 10 1A: eighteen skills from the signed content pack (CV10_A02, A03, A05), listed only as today's gate allows." },
  ...
  { path: "/clinician/member/[id]/assigned/[assignmentId]", audience: "clinician", job: "Read the runs of a practice you assigned: distress before and after, and what was written.", workspace: "person_record", state: "working", evidence: "Handoff 10 Phase 3 (CV10_E02): the assigning clinician only; a colleague is told whose it is and shown nothing. Each read is audited." },
  { path: "/clinician/assigned-lane/[moduleId]", audience: "clinician", job: "Preview a clinician-assigned practice exactly as the person will see it.", workspace: "command_center", state: "working", evidence: "Handoff 03 §4: the same step component the person's run uses. Demo only while rows E01 to E05 are unsigned." },
  ...
  { path: "/review/work", audience: "reviewer", job: "See what is built, what each claim rests on, and what is deliberately not built.", workspace: "review_console", state: "working", evidence: "The register is checked against the SOURCE rather than maintained by hand: the symbol exists where the entry says it does, a named test mentions it, and something outside its own module refers to it. That third check is the one that caught a feature built, tested and reachable from no screen. It proves a person can get to the thing; it does not prove the thing helps them, which is the testing console's question." },
